    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <div className="w-full max-w-md rounded-3xl border border-white/10 bg-white/10 p-8 backdrop-blur">
        <div className="mb-6 flex flex-col items-center">
          ...
          <h1 className="mt-4 text-xl font-semibold text-white">Overtime DT</h1>
          <p className="text-sm text-slate-200/80">Panel para directores técnicos, entrenadores y staff</p>
        </div>
